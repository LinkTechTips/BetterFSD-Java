...
public class GlobalConstants {
    public static final String PRODUCT = "BetterFSD Java Edition Version 1.1.2-hotfix1 By 4185 QQ:3174327625";
    public static final String VERSION = "V1.1.2-hotfix1";
